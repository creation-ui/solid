...
const COLORS: ColorDefinition[] = [
  { value: 'primary', label: 'primary', class: 'bg-primary-500' },
  { value: 'success', label: 'success', class: 'bg-success-500' },
  { value: 'warning', label: 'warning', class: 'bg-warning-500' },
  { value: 'error', label: 'error', class: 'bg-error-500' },
