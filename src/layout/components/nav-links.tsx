    ...
    >
      {prev && (
        <Anchor
          href={prev.route}
          title={prev.title}
          class={cn(classes.link, 'ltr:nx-pr-4 rtl:nx-pl-4')}
        >
          <ArrowRightIcon class={cn(classes.icon, 'ltr:nx-rotate-180')} />
          {prev.title}
        </Anchor>
      )}
      {next && (
        ...
        >
          {next.title}
          <ArrowRightIcon class={cn(classes.icon, 'rtl:nx-rotate-180')} />
        </Anchor>
      )}
    </div>
  )
