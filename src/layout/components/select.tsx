        ...
        >
          ...
          <Portal>
            <Transition
              ...
              show={open}
              as={Listbox.Options}
              class="nx-z-20 nx-max-h-64 nx-overflow-auto nx-rounded-md nx-ring-1 nx-ring-black/5 nx-bg-white nx-py-1 nx-text-sm nx-shadow-lg dark:nx-ring-white/20 dark:nx-bg-neutral-800"
              ...
              {options.map(option => (
                ...
                >
                  ...
                  {option.key === selected.key && (
                    <span class="nx-absolute nx-inset-y-0 nx-flex nx-items-center ltr:nx-right-3 rtl:nx-left-3">
                      <CheckIcon />
                    </span>
                  )}
                </Listbox.Option>
