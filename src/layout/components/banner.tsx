...
export function Banner(): ReactElement | null {
  ...
  return (
    <>
      ...
      >
        <div class="nx-w-full nx-truncate nx-px-4 nx-text-center nx-font-medium nx-text-sm">
        ...
        {banner.dismissible && (
          <button
            ...
            class="nx-w-8 nx-h-8 nx-opacity-80 hover:nx-opacity-100"
            onClick={() => {
              try {
          ...
          >
            <XIcon class="nx-mx-auto nx-h-4 nx-w-4" />
          </button>
        )}
      </div>
    </>
