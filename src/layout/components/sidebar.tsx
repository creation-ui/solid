...
function FolderImpl({ item, anchors }: FolderProps): ReactElement {
  ...
  return (
    <li class={cn({ open, active })}>
      ...
      <Collapse class="ltr:nx-pr-0 rtl:nx-pl-0 nx-pt-1" isOpen={open}>
        {Array.isArray(item.children) ? (
          <Menu
            class={cn(classes.border, 'ltr:nx-ml-3 rtl:nx-mr-3')}
  ...
  return (
    ...
    >
      {title ? (
        ...
        <hr class="nx-mx-2 nx-border-t nx-border-gray-200 dark:nx-border-primary-100/10" />
      )}
    </li>
  )
}
...
function Menu({
  ...
  return (
    <ul class={cn(classes.list, class)}>
  ...
  return (
    <>
      {includePlaceholder && asPopover ? (
        <div class="max-xl:nx-hidden nx-h-0 nx-w-64 nx-shrink-0" />
      ) : null}
      <div
        class={cn(
      ...
      >
            ...
            >
              ...
              {(!asPopover || !showSidebar) && (
                <Collapse isOpen={showSidebar} horizontal>
                  <Menu
                    class="nextra-menu-desktop max-md:nx-hidden"
              ...
              {mounted && window.innerWidth < 768 && (
                <Menu
                  class="nextra-menu-mobile md:nx-hidden"
        ...
        {hasMenu && (
          ...
          >
            <LocaleSwitch
              lite={!showSidebar}
              class={cn(showSidebar ? 'nx-grow' : 'max-md:nx-grow')}
            />
            {config.darkMode && (
              <div
                class={
            ...
            {config.sidebar.toggleButton && (
              <button
                ...
                class="max-md:nx-hidden nx-h-7 nx-rounded-md nx-transition-colors nx-text-gray-600 dark:nx-text-gray-400 nx-px-2 hover:nx-bg-gray-100 hover:nx-text-gray-900 dark:hover:nx-bg-primary-100/5 dark:hover:nx-text-gray-50"
                onClick={() => {
