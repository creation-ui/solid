    ...
    for (let i = 0; i < pageResults.length; i++) {
      ...
      for (let j = 0; j < sectionResults.length; j++) {
        ...
        results.push({
          ...
          children: (
            <>
              <div class="nx-text-base nx-font-semibold nx-leading-5">
                <HighlightMatches match={search} value={title} />
              </div>
              {content && (
                <div class="excerpt nx-mt-1 nx-text-sm nx-leading-[1.35rem] nx-text-gray-600 dark:nx-text-gray-400 contrast-more:dark:nx-text-gray-50">
