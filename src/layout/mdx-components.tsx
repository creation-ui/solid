...
const Details = ({
  ...
  return (
    <details
      class="nx-my-4 nx-rounded nx-border nx-border-gray-200 nx-bg-white nx-p-2 nx-shadow-sm first:nx-mt-0 dark:nx-border-neutral-800 dark:nx-bg-neutral-900"
      {...props}
...
export const Link = ({ href = '', class, ...props }: AnchorProps) => (
  <Anchor
    href={href}
...
export const getComponents = ({
  ...
  return {
    h1: props => (
      <h1
        class="nx-mt-2 nx-text-4xl nx-font-bold nx-tracking-tight nx-text-slate-900 dark:nx-text-slate-100"
        {...props}
      />
    ),
    ...
    ul: props => (
      <ul
        class="nx-mt-6 nx-list-disc first:nx-mt-0 ltr:nx-ml-6 rtl:nx-mr-6"
        {...props}
      />
    ),
    ol: props => (
      <ol
        class="nx-mt-6 nx-list-decimal first:nx-mt-0 ltr:nx-ml-6 rtl:nx-mr-6"
        {...props}
      />
    ),
    li: props => <li class="nx-my-2" {...props} />,
    blockquote: props => (
      <blockquote
        class={clsx(
    ...
    hr: props => (
      <hr
        class="nx-my-8 nx-border-neutral-200/70 contrast-more:nx-border-neutral-400 dark:nx-border-primary-100/10 contrast-more:dark:nx-border-neutral-400"
        {...props}
      />
    ),
    a: Link,
    table: props => (
      <Table
        class="nextra-scrollbar nx-mt-6 nx-p-0 first:nx-mt-0"
        {...props}
      />
    ),
    p: props => <p class="nx-mt-6 nx-leading-7 first:nx-mt-0" {...props} />,
    tr: Tr,
    th: Th,
    td: Td,
    details: Details,
